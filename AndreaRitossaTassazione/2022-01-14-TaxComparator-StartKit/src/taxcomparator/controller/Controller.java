...
public class Controller {
	...
	public void setFasce(Fasce fasce) {
		this.fasceCorrenti=fasce;
	}

	public Fasce getFasce() {
		return fasceCorrenti;
	}

	public double calcolaImposte(double reddito) {
		return calcolatoreImposte.calcolaImposta(reddito, fasceCorrenti);
	}
	
	public String getLog() {
		return calcolatoreImposte.getLog();
	}

	public List<Fasce> getListaFasceDisponibili() {
		return listaFasce;
	}
	
	public static void alert(String title, String headerMessage, String contentMessage) {
		TaxComparatorApp.alert(title, headerMessage, contentMessage);
	}
}
