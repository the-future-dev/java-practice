...
//		System.out.println("Row ["+board.getCountingRow().length+"]:");
//		for (int i : board.getCountingRow()) {
//			System.out.print(i);
//		}
		System.out.println(board.getCountingCol().length);
	...
	void testSetCell_OK() {
		board.setCell(0,1,ShipItem.SINGLE);
		for (int r : board.getCountingRow())
			System.out.print(r);
		System.out.println("");
		assertEquals(5, board.countShipCellsInRow(0));
